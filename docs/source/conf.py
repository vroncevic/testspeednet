...
htmlhelp_basename: str = 'testspeednetdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'testspeednet.tex', 'testspeednet Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'testspeednet', 'testspeednet Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'testspeednet', 'testspeednet Documentation', author,
    'testspeednet', 'One line description of project.', 'Miscellaneous'
)]
